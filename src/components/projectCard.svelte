...
<div class="h-auto w-auto rounded-md border-[1px] border-black p-2 dark:border-white">
	<div class="flex justify-between">
		<p class="my-auto">{project.name}</p>
		<button
			onclick={togglePopup}
			aria-label="Show popup"
			class="rounded-md border-[1px] hover:bg-black dark:hover:bg-white"
		>
			<xml version="1.0" encoding="utf-8">
				<svg
					...
					class="fill-black hover:fill-white dark:fill-white dark:hover:fill-black"
				>
					<path
						class="m-auto"
